// PARAMETERS: Function: Body Mass Index (BMI) Calculator: "Determine BMI by entering height and weight, and provide health recommendations. Example: User enters their height and weight to calculate BMI and receive health advice Product: Laptops Style: Sherlock Holmes
<?php
$servername = "db";
$username = "root";
$password = "root";
